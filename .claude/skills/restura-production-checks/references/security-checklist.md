...
The `tests/security/*` suite runs under `test:run`, but knowing _which_ test guards _your_ change tells you whether you've broken (or need to extend) a boundary.
