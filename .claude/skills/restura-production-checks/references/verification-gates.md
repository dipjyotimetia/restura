...
| Capability matrix | `npm run capabilities:check` | Stale `docs/CAPABILITY_MATRIX.md` vs `capabilities.ts` | Whether the capability value is *correct* — only checks freshness |
