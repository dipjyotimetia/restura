...
export function ParamRow({
  ...
  const baseInput =
    'bg-transparent outline-none text-sp-text placeholder:text-sp-dim font-mono text-sp-12 w-full px-2 py-1 focus:bg-sp-hover focus:ring-1 focus:ring-sp-accent/30 transition-colors';
  ...
  return (
    <div
      className={cn(
        'group grid items-stretch border-b border-sp-line transition-colors',
        'hover:bg-sp-hover',
    ...
    >
      ...
      <div className="border-l border-sp-line/40 flex items-center min-w-0">
        <input
          ...
          className="bg-transparent outline-none text-sp-muted placeholder:text-sp-dim text-sp-11-5 w-full px-2 py-1 focus:bg-sp-hover focus:ring-1 focus:ring-sp-accent/30 transition-colors"
        />
      </div>
      <div className="flex items-center justify-center py-0.5">
        <button
