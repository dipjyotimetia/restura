  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium tracking-tight transition-all duration-200 ease-out focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-slate-200 dark:border-slate-700 bg-white/5 dark:bg-white/5 backdrop-blur-sm shadow-sm hover:bg-slate-blue-50 dark:hover:bg-slate-blue-950/30 hover:text-slate-blue-700 dark:hover:text-slate-blue-300 hover:border-slate-blue-300 dark:hover:border-slate-blue-700 hover:shadow-elevation-1 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-slate-blue-500/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background',
        secondary:
          'bg-slate-100 dark:bg-slate-800/50 text-slate-900 dark:text-slate-100 shadow-sm hover:bg-slate-200 dark:hover:bg-slate-700/50 hover:shadow-elevation-1 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-slate-400/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background',
        ghost:
          'hover:bg-slate-100 dark:hover:bg-white/10 hover:text-slate-blue-700 dark:hover:text-slate-blue-300 active:scale-[0.95] focus-visible:ring-2 focus-visible:ring-slate-blue-500/30 focus-visible:ring-offset-0',
        ...
        glass:
          'bg-white/20 dark:bg-white/10 backdrop-blur-md border border-white/20 dark:border-white/10 shadow-glass noise-texture hover:bg-white/30 dark:hover:bg-white/20 hover:border-white/30 dark:hover:border-white/20 hover:shadow-elevation-2 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-slate-blue-500/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background',
      },
      size: {
