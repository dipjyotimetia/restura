 ...
 * hook, the Auth-tab "Inherits…" hint, and the OWS saved-request dispatcher.
 * The collection runner does NOT use this — `flattenRunnables` threads the
 * same rule in its single tree pass.
 */
