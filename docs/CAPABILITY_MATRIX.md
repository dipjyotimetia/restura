...
| PAC proxy script resolution | ❌ | ✅ | Available through administrator-managed desktop policy; Electron resolves the PAC result before app-owned transports connect |
