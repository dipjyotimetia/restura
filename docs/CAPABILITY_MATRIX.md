...
| PAC proxy script resolution | ❌ | ❌ | User-selectable PAC remains unavailable in the renderer; administrators can enforce PAC end-to-end through protected desktop enterprise policy. |
