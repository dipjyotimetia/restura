...
Full request / response shapes for each endpoint, including streaming framing, are documented in [`docs/API.md`](https://github.com/dipjyotimetia/restura/blob/main/docs/API.md).
</Aside>
