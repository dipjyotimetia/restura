...
description: Install the pinned Node/npm toolchain, run npm ci, and learn the core dev, test, lint, and validate commands — plus the type-check vs type-check:all gotcha.
---
