...
The full self-hosting guide — including reverse proxy snippets and the multi-replica caveat — lives in [`docs/SELF_HOSTING.md`](https://github.com/dipjyotimetia/restura/blob/main/docs/SELF_HOSTING.md).
</Aside>
...
- [Capability matrix](/reference/capability-matrix/) — what does *not* work in self-hosted mode.
