...
- **Custom CAs**, **disabled TLS verification**, **client certificates (mTLS)**, **SOCKS4/5** and **PAC** are <Badge text="desktop only" variant="caution" /> — the browser sandbox doesn't expose them.
