...
See [`docs/ARCHITECTURE.md`](https://github.com/dipjyotimetia/restura/blob/main/docs/ARCHITECTURE.md) on GitHub for the canonical source-of-truth for contributors.
