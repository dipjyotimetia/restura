...
timeline
  ...
  2026-07-03 : 0027 — Privacy-preserving usage signal
  2026-07-16 : 0028 — Codex harness + shipping gates
```
...
<CardGrid>
  ...
  />
  <LinkCard
    title="0027 — Privacy-preserving usage signal"
    description="Anonymous desktop Release Health sessions and infrastructure-only web metrics, with no per-user analytics or self-host collection."
    href="/architecture/adrs/0027-telemetry-and-privacy-preserving-usage-analytics/"
  />
  <LinkCard
    title="0028 — Codex agentic harness and shipping gates"
    ...
    href="/architecture/adrs/0028-codex-agentic-harness-and-shipping-gates/"
  />
</CardGrid>

## Related

- [Architecture overview](/architecture/overview/) — the three-backend model these ADRs decide on.
- [Shared protocol layer](/architecture/shared-protocol/) — the deep dive behind ADR 0001.
- [Security model](/architecture/security/) — the consolidated design behind ADR 0004 and ADR 0006.
