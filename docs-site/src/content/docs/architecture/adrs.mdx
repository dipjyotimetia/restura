...
timeline
  ...
  2026-06-02 : 0008 — OpenCollection native format
             : 0009 — Shared Hono app factory
             : 0010 — AI assistant architecture
             : 0011 — Restura as an MCP server
             : 0012 — Capability matrix source of truth
             : 0013 — Hash routing
             : 0014 — Zustand persistence
             : 0015 — QuickJS script sandbox
             : 0016 — Wire-level auth signing
             : 0017 — Runtime platform detection
             : 0018 — Rate limiting strategy
             : 0019 — Response viewer architecture
  2026-06-03 : 0020 — AI Lab eval workbench
  2026-06-04 : 0021 — Maintenance harness
```
