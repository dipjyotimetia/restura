...
<CardGrid>
  ...
  />
  <LinkCard
    title="0027 — Telemetry + privacy-preserving usage"
    description="The minimum disclosed error and session-health signal: opt-out, scrubbed, non-identifying, and no new application-level web analytics."
