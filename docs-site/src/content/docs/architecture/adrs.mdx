...
Architecture Decision Records capture significant design choices, the alternatives considered, and the reasoning. They're the single best resource if you want to understand _why_ the code is shaped the way it is.
