...
- Source: [`docs/adr/0021-maintenance-harness.md`](https://github.com/dipjyotimetia/restura/blob/main/docs/adr/0021-maintenance-harness.md)
- Related: [ADR 0004](/architecture/adrs/0004-security-hardening/), [ADR 0006](/architecture/adrs/0006-connection-and-dns-hardening/), [ADR 0007](/architecture/adrs/0007-secret-ref-pattern/), [ADR 0012](/architecture/adrs/0012-capability-matrix-source-of-truth/), [ADR 0016](/architecture/adrs/0016-wire-level-auth-signing/).
