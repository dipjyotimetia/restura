...
- [ADR 0003 — Streaming and HTTP/2](/architecture/adrs/0003-streaming-and-http2/) — the streaming transports this viewer split is designed around.
- [SSE protocol](/protocols/sse/) — one of the streaming responses that renders in the incremental viewer.
- [gRPC protocol](/protocols/grpc/) — server-streaming responses, the other consumer of the capped viewer.
