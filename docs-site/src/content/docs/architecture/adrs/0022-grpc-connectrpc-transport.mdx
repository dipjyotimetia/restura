...
- [gRPC protocol](/protocols/grpc/) — the user-facing feature this transport backs.
- [ADR 0001 — Shared Protocol Layer](/architecture/adrs/0001-shared-protocol-layer/) — the single-core pattern the descriptor registry follows.
- [ADR 0003 — Streaming and HTTP/2](/architecture/adrs/0003-streaming-and-http2/) — superseded in part by this ADR.
- [ADR 0006 — Electron Connection Cleanup + Pre-flight DNS Guard](/architecture/adrs/0006-connection-and-dns-hardening/) — the `lookup`-based SSRF pinning this transport now shares.
