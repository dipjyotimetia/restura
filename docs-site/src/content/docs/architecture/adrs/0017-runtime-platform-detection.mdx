...
- [ADR 0001 — Shared Protocol Layer](/architecture/adrs/0001-shared-protocol-layer/) — the executors that branch on `isElectron()`.
- [ADR 0012 — Capability Matrix Source of Truth](/architecture/adrs/0012-capability-matrix-source-of-truth/) — where platform capability differences belong instead.
