...
- [ADR 0004 — Security Hardening](/architecture/adrs/0004-security-hardening/) — the earlier hardening pass this one closes gaps in.
- [ADR 0006 — Electron Connection Cleanup + Pre-flight DNS Guard](/architecture/adrs/0006-connection-and-dns-hardening/) — the sibling renderer-facing hardening pass.
