...
- Source: [`docs/adr/0016-wire-level-auth-signing.md`](https://github.com/dipjyotimetia/restura/blob/main/docs/adr/0016-wire-level-auth-signing.md)
- Docs: [Authentication](/guides/auth/).
- Related: [ADR 0001](/architecture/adrs/0001-shared-protocol-layer/), [ADR 0004](/architecture/adrs/0004-security-hardening/), [ADR 0007](/architecture/adrs/0007-secret-ref-pattern/).
