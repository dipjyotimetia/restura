...
<Aside title="Read the source">
  - [`docs/security.md`](https://github.com/dipjyotimetia/restura/blob/main/docs/security.md) —
  at-rest encryption details. - [ADR 0004 — Security hardening](/architecture/adrs/) - [ADR 0006 —
  Electron connection + DNS hardening](/architecture/adrs/) - [ADR 0007 — SecretRef
