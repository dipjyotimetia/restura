...
The browser sandbox can't expose raw TCP, custom CAs, or SOCKS. Restura surfaces this as **"Desktop only" badges** on UI fields whose underlying capability isn't available on the platform you're using. The desktop app also supports administrator-enforced system, fixed, or PAC proxying for application and update traffic.
