...
<Aside type="note">
  The exact, machine-generated truth lives in
  [`src/lib/shared/capabilities.ts`](https://github.com/dipjyotimetia/restura/blob/main/src/lib/shared/capabilities.ts)
  and is published as the [capability matrix](/reference/capability-matrix/).
</Aside>
