...
- **Restura _as_ an MCP server** — Expose your collections, environments, and history to an agent like Claude. Per-tool consent gates and secret redaction built in.
...
- No accounts. No cloud sync. No telemetry. No team workspaces.
