...
description: A multi-protocol API client for developers — HTTP, GraphQL, gRPC, WebSocket, Socket.IO, SSE, Kafka, MCP — that runs in the browser, on your desktop, or self-hosted.
---
...
- **Eight protocols out of the box** — HTTP/REST, GraphQL, gRPC, WebSocket, Socket.IO, Server-Sent Events, Kafka, and Model Context Protocol.
